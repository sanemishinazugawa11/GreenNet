  ...
  return (
    <div className="w-full px-8 py-3 mt-10 sm:mt-14 overflow-x-hidden max-w-screen-lg mx-auto ">
      <div className="w-full md:w-[95%] mx-auto flex flex-col gap-4 items-center">
        ...
        }} className="max-w-md w-full hover:cursor-pointer bg-de-york-400 px-4 py-2 text-center flex items-center justify-center font-Raleway font-semibold gap-1 mt-8 rounded-md">
